        ...
        <div className="flex items-center gap-2">
          {notifications.some(n => !n.read) && notifications.length > 0 && (
            <button
              ...
              className="p-2 rounded-full border-2 border-green-400 dark:border-green-500 bg-white/80 dark:bg-gray-900/80 text-green-500 dark:text-white hover:bg-green-500 dark:hover:bg-green-600 hover:text-white dark:hover:text-white transition-colors duration-200 shadow-md"
          ...
          {notifications.length > 0 && (
            <button
              ...
              className="p-2 rounded-full border-2 border-red-400 dark:border-red-500 bg-white/80 dark:bg-gray-900/80 text-red-500 dark:text-white hover:bg-red-500 dark:hover:bg-red-600 hover:text-white transition-colors duration-200 shadow-md"
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-full border-2 border-yellow-400 dark:border-yellow-500 bg-white/80 dark:bg-gray-900/80 text-yellow-500 dark:text-white hover:bg-yellow-400 dark:hover:bg-yellow-700 hover:text-white transition-colors duration-200 shadow-md"
